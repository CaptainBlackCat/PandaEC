...
import com.wta.NewCloudApp.jiuwei138940.latte_ui.drawable.QMUIMaterialProgressDrawable;
import com.wta.NewCloudApp.jiuwei138940.latte_ui.util.QMUIDisplayHelper;

import static com.wta.NewCloudApp.jiuwei138940.latte_ui.R.styleable.QMUIPullRefreshLayout_qmui_refresh_progress_color;
import static com.wta.NewCloudApp.jiuwei138940.latte_ui.R.styleable.QMUIPullRefreshLayout_qmui_target_init_offset;
...
public class QMUIPullRefreshLayout extends ViewGroup implements NestedScrollingParent {
    ...
    private int mProgressColor=0xFFF21C30;
    ...
    public QMUIPullRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mTargetInitOffset = array.getDimensionPixelSize(
                    QMUIPullRefreshLayout_qmui_target_init_offset, 0);

            mProgressColor=array.getColor(QMUIPullRefreshLayout_qmui_refresh_progress_color,0xFFF21C30);
    ...
    protected View createRefreshView() {
        return new RefreshView(getContext(),mProgressColor);
    }
    ...
    public static class RefreshView extends ImageView implements IRefreshView {
        ...
        public RefreshView(Context context,int color) {
            super(context);

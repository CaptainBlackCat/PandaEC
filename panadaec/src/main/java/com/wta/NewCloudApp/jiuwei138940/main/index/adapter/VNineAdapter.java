...
public class VNineAdapter extends DelegateAdapter.Adapter<VNineAdapter.ViewHolder> {

    private IndexBean.InfoBean.DataBean infoBean;
    private Context mContext;
    private int type;

    public VNineAdapter(Context mContext, IndexBean.InfoBean.DataBean infoBean, int type) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        if(getItemViewType(position)==type) {
            ...
            holder.mRecyclerView.setAdapter(new HomeNineAdapter(infoBean.getCellData()));
        }
    }

...
public class GoodsDetail_miaosha extends LatteDelegate{
    ...
    public static GoodsDetail_miaosha newInstance(int contentId) {
        final Bundle args = new Bundle();
        args.putInt(ARG_CONTENT_ID, contentId);
        final GoodsDetail_miaosha delegate = new GoodsDetail_miaosha();
    ...
    public Object setLayout() {
        return R.layout.goods_detail_miaosha;
    }
                ...
                .success(new ISuccess() {
                    ...
                    public void onSuccess(String response) {
                        ...
                        if (retData.getData().getRet() == 0) {
                            ...
                            goodsInfoFragment.setParentFragment(GoodsDetail_miaosha.this);

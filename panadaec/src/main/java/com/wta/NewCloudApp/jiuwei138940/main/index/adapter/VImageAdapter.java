...
public class VImageAdapter extends DelegateAdapter.Adapter<VImageAdapter.ViewHolder>  {

    private IndexBean.InfoBean.DataBean infoBean;
    private Context mContext;
    private int type;
    public VImageAdapter(Context mContext, IndexBean.InfoBean.DataBean infoBean, int type) {
    ...
    @Override
    public VImageAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View inflate = LayoutInflater.from(mContext).inflate(R.layout.home_first_img, parent, false);
            return new ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(VImageAdapter.ViewHolder holder, int position) {

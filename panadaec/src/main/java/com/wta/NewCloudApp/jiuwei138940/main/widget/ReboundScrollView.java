...
public class ReboundScrollView extends ScrollView {
    ...
    private OnButtomRefreshListener onButtomRefreshListener;
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if(canPullDown && deltaY>0){
                    if(onTopRefreshListener!=null) {
                        onTopRefreshListener.onTopRefresh();
                    }
                }else if(canPullUp && deltaY< 0){
                    if(onButtomRefreshListener!=null) {
                        onButtomRefreshListener.onButtomRefresh();
                    }
                }
    ...
    public interface OnButtomRefreshListener{
        void onButtomRefresh();
    }
    ...
    public void setOnButtomRefreshListener(OnButtomRefreshListener onButtomRefreshListener){
        this.onButtomRefreshListener=onButtomRefreshListener;
    }

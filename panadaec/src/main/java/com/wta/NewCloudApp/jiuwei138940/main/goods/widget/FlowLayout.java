package com.wta.NewCloudApp.jiuwei138940.main.goods.widget;
...
public class FlowLayout extends ViewGroup implements CompoundButton.OnCheckedChangeListener {
    ...
    public static int POSITION_GROUP = -1;
    public static int POSITION_CHILD = -2;
    ...
    @Override
    public void addView(View child,int GroupPosition,int ChildPosition) {
        /**
         * 设置每个radiobutton位置信息
         */
        child.setTag(POSITION_GROUP,GroupPosition);
        child.setTag(POSITION_CHILD,ChildPosition);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (isChecked) {
            ...
            if (listener != null) {
                listener.onSelected(getTitle(), buttonView.getText().toString(),buttonView);
            }
        }
